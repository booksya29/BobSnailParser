# Харків METRO (zakaz Харків) Харків  
...
async def set_addr(page:Page) -> bool:
    try:
        ...
        await page.locator('div[id*="react-select-"]', has_text='Харків').click() # Адреса в списку
