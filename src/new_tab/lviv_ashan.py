# Львів Auchan (Львів) https://auchan.zakaz.ua/uk/ Львів  
...
async def set_addr(page:Page) -> bool:
    try:
        ...
        await page.locator('div[id*="react-select-"]', has_text='Львів').click() # Адреса в списку
