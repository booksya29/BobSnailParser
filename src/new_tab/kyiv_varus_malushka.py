...
async def select_addr(page:Page):
    try:
        ...
        await page.get_by_role("button", name="Київ").click()
        await page.get_by_role("textbox").nth(3).click()
        await asyncio.sleep(1)
        await page.get_by_role("button", name="вул. А. Малишка, 3").click()
