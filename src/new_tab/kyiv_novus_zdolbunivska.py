...
async def set_addr(page:Page) -> bool:
    try:
        ...
        await page.locator('div[id*="react-select-"]', has_text='Київ').click() # Адреса в списку
        await page.locator('div[class="SelectStyled__single-value css-r447wv-singleValue"]').nth(1).click() # nth 0 - населений пункт, nth 1 - місце видачі
        await page.locator('div[id*="react-select-"]', has_text='Осокор').click() # Адреса в списку
...
async def test():
    async with async_playwright() as pw:
        ...
        urls = ['https://novus.zakaz.ua/uk/products/maslo-bilotserkivske-180g-ukrayina--04820019493565/', 'https://novus.zakaz.ua/uk/products/frukt-nektarin--novus02850541000000/', 'https://novus.zakaz.ua/uk/products/khlib-kulinichi-330g--04820140110669/']
        for i in urls:
