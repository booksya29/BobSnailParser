...
async def select_addr(page:Page):
    ...
    await asyncio.sleep(1)
    await page.locator('li[class*="select2-results__option"]', has_text='Дніпро').first.click(timeout=3000)
    await page.locator('span[class="select2-selection select2-selection--single"]').nth(1).click(timeout=3000)
    await asyncio.sleep(1)
    await page.locator('li[class*="select2-results__option"]', has_text='Зоряний').click(timeout=3000)
