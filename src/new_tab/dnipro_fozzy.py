...
async def select_addr(page: Page):
    ...
    try:
        await page.locator('div[id="checkin_content_addresses_content"]').locator('div[class*="checkin_address_block"]', has_text='Дніпро').text_content(timeout=2000)
        ...
        await page.locator('div[class="add_address_list js-pickup-address-list"]').get_by_text('Дніпро').click()
        await page.locator('button[class="add_address_button"]').click()
        await page.locator('div[id="timeslots_button_panel"]').click()
        return True
    
    await page.locator('div[class*="checkin_address_block"]', has_text='Дніпро').click()
