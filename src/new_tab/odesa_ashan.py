...
async def set_addr(page:Page) -> bool:
    try:
        ...
        await page.locator('div[id*="react-select-"]', has_text='Одеса').click() # Адреса в списку
